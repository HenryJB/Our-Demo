      ...
      <div class="container">
        <div class="product-agileinfo-grids w3l">
          <div class="col-md-3 product-agileinfo-grid">
            ...
            <div class="top-rates">
              ...
              <div class="recent-grids">
                <div class="recent-left">
                  <a href="single.html">
                      <?php echo Html::img('@web/images/r.jpg', $options=['class'=> 'img-responsive']) ?>
                  </a>
                </div>
              ...
              <div class="recent-grids">
                <div class="recent-left">
                  <a href="single.html">
                      <?php echo Html::img('@web/images/r1.jpg', $options=['class'=> 'img-responsive']) ?>
                  </a>
                </div>
                <div class="recent-right">
              ...
              <div class="recent-grids">
                <div class="recent-left">
                  <a href="single.html">
                      <?php echo Html::img('@web/images/r2.jpg', $options=['class'=> 'img-responsive']) ?>
                  </a>
                </div>
                <div class="recent-right">
                  <h6 class="best2"><a href="single.html">Lorem ipsum dolor </a></h6>
              ...
              <div class="recent-grids">
                <div class="recent-left">
                  <a href="single.html">
                      <?php echo Html::img('@web/images/r3.jpg', $options=['class'=> 'img-responsive']) ?>
                  </a>
                </div>
                <div class="recent-right">
            ...
            <div class="cat-img">
                <?php echo Html::img('@web/images/45.jpg', $options=['class'=> 'img-responsive']) ?>
            </div>
          </div>
          <div class="col-md-9 product-agileinfon-grid1 w3l">
            <div class="product-agileinfon-top">
              <div class="col-md-6 product-agileinfon-top-left">
                <?php echo Html::img('@web/images/img1.jpg', $options=['class'=> 'img-responsive']) ?>
              </div>
              <div class="col-md-6 product-agileinfon-top-left">
                <?php echo Html::img('@web/images/img2.jpg', $options=['class'=> 'img-responsive']) ?>
              </div>
              <div class="clearfix"></div>
            </div>
                      ...
                      <div class="grid-arr">
                        <div  class="grid-arrival">
                          <figure>
                            <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                              <div class="grid-img">
                              <?php echo Html::img('@web/images/i2.jpg', $options=['class'=> 'img-responsive']) ?>
                              </div>
                              <div class="grid-img">
                                <?php echo Html::img('@web/images/i1.jpg', $options=['class'=> 'img-responsive']) ?>
                              </div>
                            </a>
                          </figure>
                        </div>
                      ...
                      <div class="grid-arr">
                        <div  class="grid-arrival">
                          <figure>
                            <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                              <div class="grid-img">
                                <?php echo Html::img('@web/images/i4.jpg', $options=['class'=> 'img-responsive']) ?>
                              </div>
                              <div class="grid-img">
                                <?php echo Html::img('@web/images/i3.jpg', $options=['class'=> 'img-responsive']) ?>
                              </div>
                            </a>
                          </figure>
                        </div>
                      ...
                      <div class="grid-arr">
                        <div  class="grid-arrival">
                          <figure>
                            <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                              <div class="grid-img">
                                <?php echo Html::img('@web/images/i6.jpg', $options=['class'=> 'img-responsive']) ?>
                              </div>
                              <div class="grid-img">
                              <?php echo Html::img('@web/images/i5.jpg', $options=['class'=> 'img-responsive']) ?>
                              </div>
                            </a>
                          </figure>
                        </div>
                      ...
                      <div class="grid-arr">
                        <div  class="grid-arrival">
                          <figure>
                            <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                              <div class="grid-img">
                                <?php echo Html::img('@web/images/i8.jpg', $options=['class'=> 'img-responsive']) ?>
                              </div>
                              <div class="grid-img">
                                <?php echo Html::img('@web/images/i7.jpg', $options=['class'=> 'img-responsive']) ?>
                              </div>
                            </a>
                          </figure>
                        </div>
                      ...
                      <div class="grid-arr">
                        <div  class="grid-arrival">
                          <figure>
                            <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                              <div class="grid-img">
                                <?php echo Html::img('@web/images/i10.jpg', $options=['class'=> 'img-responsive']) ?>
                              </div>
                              <div class="grid-img">
                                <?php echo Html::img('@web/images/i9.jpg', $options=['class'=> 'img-responsive']) ?>
                              </div>
                            </a>
                          </figure>
                        </div>
                      ...
                      <div class="grid-arr">
                        <div  class="grid-arrival">
                          <figure>
                            <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                              <div class="grid-img">
                                <?php echo Html::img('@web/images/i12.jpg', $options=['class'=> 'img-responsive']) ?>
                              </div>
                              <div class="grid-img">
                                <?php echo Html::img('@web/images/i11.jpg', $options=['class'=> 'img-responsive']) ?>
                              </div>
                            </a>
                          </figure>
                        </div>
